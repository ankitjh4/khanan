...
The compressed `../outputs/india_mining_dataset_csv_bundle_v1.0-alpha.1.zip` is the current portable development release. It packages the v0.6 geospatial/model baseline together with the v1 ontology and source-term crosswalk. The uncompressed nationwide grid is regenerated locally and excluded from the Git checkout because it exceeds GitHub's ordinary file-size limit.
