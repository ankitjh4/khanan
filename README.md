...
| `outputs/source_registry.csv` | 37 | Provenance, access/licensing notes, uses and limitations. |
| `outputs/data_dictionary.csv` | 1,663 | Field definitions, units and missing-value policies. |
