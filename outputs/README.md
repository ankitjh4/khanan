...
- The root contains the v0.8 geospatial feature baseline and unchanged v0.6 prospectivity model in the current v1.0-alpha.8 development release: the v1 ontology, IBM abandoned-mine and 2024 mineral-concession context, metadata-only NGDR/GSI service audit, EMAG2v3 and SoilGrids context plus paired spatial ablations, crosswalk, validation, checksums and compressed bundle.
