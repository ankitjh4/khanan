...
- The root contains the v0.6 geospatial/model baseline plus the current v1.0-alpha.2 ontology, IBM abandoned-mine context, crosswalk, validation, checksums and compressed development release.
...
The full `india_mining_prospectivity_grid_h3_r6.csv` is intentionally excluded from the Git checkout because it exceeds GitHub's normal single-file limit. It remains available locally and inside `india_mining_dataset_csv_bundle_v1.0-alpha.2.zip`.
