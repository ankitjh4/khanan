...
const outputDir = path.join(root, "outputs", "diagnostics", "ibm_imyb_state_review_csv_artifact_qa");

const targets = [
  {
    file: "india_ibm_state_mineral_occurrences_2024.csv",
    expectedRows: 586,
    expectedColumns: 28,
    ranges: ["A1:N14", "O1:AB14", "A570:N587", "O570:AB587"],
  },
  {
    file: "india_ibm_district_mineral_occurrences_2024.csv",
    expectedRows: 1742,
    expectedColumns: 36,
    ranges: ["A1:R14", "S1:AJ14", "A1725:R1743", "S1725:AJ1743"],
  },
  {
    file: "india_ibm_district_mineral_context_h3_r6.csv",
    expectedRows: 59872,
    expectedColumns: 31,
    ranges: ["A1:P12", "Q1:AE12", "A40000:P40012", "Q40000:AE40012"],
  },
  {
