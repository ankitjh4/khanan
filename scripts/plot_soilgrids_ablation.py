#!/usr/bin/env python3
"""Plot paired SoilGrids spatial-ablation results for the KHANAN README."""
...
SOURCE = ROOT / "outputs" / "material_soilgrids_spatial_ablation.csv"
ASSET = ROOT / "assets" / "figures" / "khanan-soilgrids-spatial-ablation-v0.1.png"
...
def main() -> None:
    ...
    ax_auc.set_xlabel("Paired out-of-fold ROC-AUC change after adding SoilGrids", fontsize=9)
    ...
    fig.suptitle("KHANAN — SoilGrids Spatial Ablation", fontsize=18, color="#0f172a", y=0.975)
    fig.text(
        0.5,
        0.932,
        (
    ...
    fig.text(
        ...
        (
            ...
            "No interval has a strictly positive lower bound; SoilGrids remains excluded from production scores and rankings."
        ),
        ha="center",
        va="bottom",
        fontsize=7.8,
